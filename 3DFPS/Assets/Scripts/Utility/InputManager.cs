...
public class InputManager : MonoBehaviour
{
    ...
    [Tooltip("Whether or not the jump button was pressed this fame")]
    public bool bigJumpPressed;
    [Tooltip("Whether or not the jump button is being held down")]
    public bool bigJumpHeld;
    ...
    public void ReadJumpInput(InputAction.CallbackContext context)
    {
     ...
     /// <param name="callbackContext">The context of the jump input</param>
    public void ReadBigJumpInput(InputAction.CallbackContext context)
    {
        bigJumpPressed = !context.canceled;
        bigJumpHeld = !context.canceled;
        StartCoroutine("ResetJumpStart");
    }
    ...
    private IEnumerator ResetBigJumpStart()
    {
        yield return new WaitForEndOfFrame();
        bigJumpPressed = false;
    }
